export interface PaperDoc {
  ...
  /** Slug used as both tone and basis for display label: drafting | review | revision | submitted | complete | outline */
  stage: string;
  progress: number;
  progressTone?: string;
  deadlineDate: string;
...
export const PAPERS_DB: PaperDoc[] = [
  ...
  },
  {
    ...
    stage: 'outline', progress: 28, progressTone: 'green',
  ...
  },
  {
    ...
    stage: 'complete', progress: 100, progressTone: 'green',
    deadlineDate: 'Apr 20, 2024', deadlineDatetime: '2024-04-20', deadlineStatus: 'Published', deadlineTone: 'success',
  ...
  },
  {
    ...
    stage: 'outline', progress: 18, progressTone: 'green',
  ...
  },
  {
    ...
    stage: 'complete', progress: 100, progressTone: 'cyan',
    deadlineDate: 'Feb 14, 2024', deadlineDatetime: '2024-02-14', deadlineStatus: 'Published', deadlineTone: 'success',
  ...
  },
  {
    ...
    stage: 'drafting', progress: 42, progressTone: 'blue',
